        ...
        <div class="modal-body">
                ...
                <form data-toggle="validator" action="/item-ajax/14" method="put">
                  ...
                  <div class="form-group">
                      ...
                      <textarea name="details" class="form-control" data-error="Please enter product group name." required></textarea>
                  ...
                  <div class="form-group">
                      ...
                      <button type="submit" id="product-group-edit" class="btn btn-success">Submit</button>
